	...
	<div class="container">
		<div class="row">
			<table class="table">
				...
				<tr>
					<th width="10%" class="text-right">전화</th>
					<td width="50%">${vo.phone }</td>
				</tr>
				<tr>
					<th width="10%" class="text-right">가격대</th>
					<td width="50%">${vo.price }</td>
				</tr>
				<tr>
					<th width="10%" class="text-right">영업시간</th>
					<td width="50%">${vo.time }</td>
				</tr>
				<tr>
					<th width="10%" class="text-right">테마</th>
					<td width="50%">${vo.theme }</td>
				</tr>
				<tr>
					<th width="10%" class="text-right">음식종류</th>
					<td width="50%">${vo.type }</td>
				</tr>
				<tr>
					<th width="10%" class="text-right">좌석</th>
								...
								<tr>
									...
									<td class="text-right">
										<c:if test="${rvo.id eq sessionScope.id }">
											...
											<a href="../reply/reply_delete.do?no=${rvo.no }&fno=${vo.fno }&typeno=0" class="btn btn-xs btn-success">삭제</a>
										</c:if>
									</td>
								</tr>
								<tr>
								...
								<tr style="display: none;" id="u${rvo.no }" class="ups">
									<td colspan="2">
										<form method="post" action="../reply/reply_update.do">
											...
											<input type="hidden" name="typeno" value="0">
